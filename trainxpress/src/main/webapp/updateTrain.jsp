...
<br><br>
  ...
  <div class="container">
    <div class="form-section">
      <u><h2>Update Train Details</h2></u>
      <form action="Tupdate" method="post" id="trainForm">
        <div class="form-group">
          <label>Train ID<span class="non-editable-note"> (*editing restricted)</span>:</label>
          <input type="number" class="form-control" name="tid" value="${param.tid}" readonly>
        </div>
        
        <div class="form-group">
          <label>Train Name:</label><span id="tnameError" class="error"></span>
          <input type="text" class="form-control" name="tname" value="${param.tname}" id="trainName">
        </div>
        
        <div class="form-group">
          <label>Engine Number:</label><span id="engineNumError" class="error"></span>
          <input type="text" class="form-control" name="tenginenum" value="${param.tenginenum}" id="engineNum">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control" name="tseatcount" value="${param.tseatcount}" id="seatCount">
        </div>
        
        <div class="form-group">
          <label>Number of Wagons:</label><span id="wagonsError" class="error"></span>
          <input type="number" class="form-control" name="tnoofwagons" value="${param.tnoofwagons}" id="noOfWagons">
        </div>
        
        <div class="buttons">
          <button type="submit">Update</button>
           <button class="back-button" onclick="window.location.href='admindashboard'">← Back</button>
        </div>
      </form>
    </div>
  ...
  <div class="container4" style="background-color: #16A34A;">
    <footer style="text-align:center; padding: 20px; font-family: Inter; color:#ffffff;display:flex;justify-content: space-between;">
        <a href="#" class="home-link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
  ...
  <script>
    ...
    trainType.addEventListener("input", function() {
      if (trainType.value.trim() === "") {
