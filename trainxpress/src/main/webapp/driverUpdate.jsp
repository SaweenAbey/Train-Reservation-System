...
<br><br>
  <div class="container">
    <div class="form-section">
      ...
      <form action="DriverUpdate" method="post" id="paymentForm">
	      ...
	      <div class="form-group">
	 		...
	 		<input type="text" class="form-control" name="fname" value="${param.fname}" id="name">  
	      </div>
	      
	      <div class="form-group">
	        <label>Last Name:</label><span id="cardnoError" class="error"></span>
			<input type="text" class="form-control" name="lname" value="${param.lname}" id="cardno">
	      </div>
	      
	      <div class="form-group">
	      <label>Address:</label><span id="expError" class="error"></span>
 			<input type="text" class="form-control" name="address" value="${param.address}" id="exp">
	      </div>
	      
	      <div class="form-group">
	        <label>LicenseNum:</label><span id="cvcError" class="error"></span>
 			<input type="text" class="form-control" name="licenseNum" value="${param.licenseNum}" id="cvc">
	      
	      </div>
	      
	      <div class="form-group">
	      	<label>Telephone Num:</label><span id="emailError" class="error"></span>
 			<input type="text" class="form-control" name="telephone" value="${param.telNo}" id="email">
	      ...
	      <div class="form-group">
			...
			<input type="number" class="form-control" name="age" value="${param.age}">
	      </div>
